...
| Metric | Value (95% CI) |
|---|---|
| Hosts F1 | **0.431** (25 prod. skills, n=6) / 0.475 [0.399, 0.542] (n=9, incl. 3 aug variants) |
| paths_read F1 | 0.368 [0.185, 0.548] |
| paths_written F1 | 0.375 [0.235, 0.543] |
| LLM predictor recall vs static regex baseline | 2.50× (0.682 vs 0.273); Wilcoxon p=0.047, McNemar's p=0.003 on n=11 incl. aug variants. Production-only n=8 gives McNemar's p≈0.125 (not significant at α=0.05); the recall gap remains directionally consistent. |
...
| Cross-LLM Jaccard on hosts axis | fresh-Claude↔Codex 0.41, orig-Claude↔Codex 0.43 |
